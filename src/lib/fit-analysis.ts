...
const QUALIFICATIONS: Qualification[] = [
  {
    ...
    aliases: ["bachelor's degree", "bachelors degree", "undergraduate degree", "university degree"],
    resumeAliases: ["bachelor of commerce", "bachelor's degree", "bachelors degree", "undergraduate degree"],
    weight: 4,
  },
  {
    label: "Canadian Securities Course",
    aliases: ["canadian securities course", "csc designation", "csc certification", "csc"],
    weight: 4,
  },
  { label: "Financial analysis", aliases: ["financial analysis", "financial analyst", "finance analysis"], weight: 4 },
  {
    label: "Financial modelling",
    aliases: ["financial modeling", "financial modelling", "valuation model", "financial models"],
    weight: 4,
  },
  {
    label: "Business analysis",
    aliases: ["business analysis", "business analyst", "business requirements"],
    weight: 4,
  },
  {
    label: "Data analysis",
    aliases: ["data analysis", "data analytics", "analytical insights", "quantitative analysis"],
    weight: 4,
  },
  {
    label: "Commercial real estate",
    aliases: ["commercial real estate", "real estate finance", "real estate lending"],
    resumeAliases: ["commercial real estate", "real estate sales", "real estate"],
    weight: 3,
  },
  {
    label: "Mortgage lending",
    aliases: ["mortgage lending", "mortgage underwriting", "mortgage credit", "mortgages"],
    weight: 3,
  },
  { label: "Banking", aliases: ["banking", "financial institution", "retail bank", "commercial bank"], weight: 3 },
  {
    label: "Wealth management",
    aliases: ["wealth management", "investment advisory", "portfolio management"],
    weight: 3,
  },
  ...
  { label: "Python", aliases: ["python"], weight: 3 },
  {
    ...
    resumeAliases: ["rstudio", "r programming", "r language", "r studio"],
    weight: 2,
  },
  ...
  { label: "SharePoint", aliases: ["sharepoint"], weight: 2 },
  {
    ...
    aliases: ["dashboard", "reporting", "management reports", "data visualization"],
    resumeAliases: ["dashboard", "reporting", "reports", "data visualization", "tableau"],
    weight: 3,
  },
  { label: "Forecasting", aliases: ["forecasting", "financial forecast", "budgeting", "variance analysis"], weight: 3 },
  {
    label: "Requirements gathering",
    aliases: ["requirements gathering", "gather requirements", "business requirements", "requirements documentation"],
    weight: 3,
  },
  {
    label: "Process improvement",
    aliases: ["process improvement", "operational improvement", "workflow improvement", "continuous improvement"],
    weight: 3,
  },
  {
  ...
  },
  {
    ...
    aliases: ["client relationship", "client management", "customer relationship", "relationship management"],
    resumeAliases: ["client relationship", "consultative sales", "client management", "relationship management"],
    weight: 3,
  },
  {
    ...
    resumeAliases: ["presentations", "presentation", "communication", "consultative sales"],
    weight: 2,
  },
  {
    label: "Project management",
    aliases: ["project management", "manage projects", "project coordination"],
    weight: 3,
  },
...
function getRecommendation(score: number, signalCount: number): { band: FitBand; action: string } {
  if (signalCount < 3)
    return { band: "Needs more detail", action: "Paste a more detailed job description before deciding." };
...
function buildSummary(matches: string[], gaps: string[], signalCount: number) {
  ...
  if (!matches.length)
    return "The profile does not yet show direct evidence for the qualifications detected in this posting.";
...
function buildSuggestions(matches: string[], gaps: string[]) {
  ...
  if (gaps.length)
    suggestions.push(
      `Do not claim missing experience. Look for adjacent evidence related to ${gaps.slice(0, 3).join(", ")}, or address it briefly in your application.`,
    );
  return suggestions;
}
